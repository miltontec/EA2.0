...
ENUM_TREND_DIRECTION CBreakoutDetector::GetImmediateDirection() {
    ...
    // CORRECCIÓN: Tiempo dinámico según timeframe
    int maxBarsValid = 0;
    switch(m_timeframe) {
        case PERIOD_M1:  maxBarsValid = 60; break;  // 1 hora
        case PERIOD_M5:  maxBarsValid = 12; break;  // 1 hora
        case PERIOD_M15: maxBarsValid = 8; break;   // 2 horas
        case PERIOD_M30: maxBarsValid = 8; break;   // 4 horas
        case PERIOD_H1:  maxBarsValid = 6; break;   // 6 horas
        case PERIOD_H4:  maxBarsValid = 6; break;   // 24 horas
        case PERIOD_D1:  maxBarsValid = 5; break;   // 5 días
        default: maxBarsValid = 5;
    }
